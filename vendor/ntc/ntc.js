...
var ntc = {
  ...
  matchName: function(color) {

    color = color.toLowerCase();

    for(var i = 0; i < ntc.names.length; i++)
    {
      if(color == ntc.names[i][1].toLowerCase()){
        //var hsl = ntc.hsl("#" + ntc.names[i][0]);
        //var h = hsl[0], s = hsl[1], l = hsl[2];
        var hsl = ntc.rgbToHsl(ntc.hexToRgb("#" + ntc.names[i][0]).r, ntc.hexToRgb("#" + ntc.names[i][0]).g, ntc.hexToRgb("#" + ntc.names[i][0]).b)
        var h = hsl[0], s = hsl[1], l = hsl[2];
        return ["#" + ntc.names[i][0], ntc.names[i][1], h, s, l, true];
      }
    }

    return ("#000000", "Invalid Color:",0,0,0, false);
  },
